...
func Build(dependencyManager DependencyManager, sbomGenerator SBOMGenerator, clock chronos.Clock, logger scribe.Emitter) packit.BuildFunc {
	return func(context packit.BuildContext) (packit.BuildResult, error) {
		...
		pnpmLayer.SharedEnv.Append("PATH", pnpmLayer.Path, string(os.PathListSeparator))
